        ...
        <View style={styles.row}>
          <View style={styles.col8}>
            <Text style={styles.addressHeading}>
              To: {order.user && order.user.name}
            </Text>
            <Text style={styles.address}>
              City: {order.shippingInfo && order.shippingInfo.city}
            </Text>
            <Text style={styles.address}>
              Adress: {order.shippingInfo && order.shippingInfo.adress}
            </Text>
            <Text style={styles.address}>
              Phone Number :{" "}
        ...
        <View style={styles.row}>
          <View style={styles.col3}>
            <Text style={styles.shipping}>
              Shipping: {order.paymentInfo && order.paymentInfo.shippingPrice}{" "}
              DT
            </Text>

            <Text style={styles.total}>
              Total Amount: {order.paymentInfo && order.paymentInfo.totalPrice}{" "}
              DT
            </Text>
          </View>
        </View>
...
const MyComponent = () => {
  const order = {
    _id: "123456789",
    shippingInfo: { address: " Street, City, State, Country" },
  };
