                  ...
                  <div className="row justify-content-center">
                      ...
                      <div className="login-form border p-5">
                          ...
                          <i class="fa fa-map-marker"></i>
                              ...
                              <label htmlFor="adress_field" className='ml-2'>Adress :</label>
                              <input type="text" id="adress_field" 
                              value={adress}
                          ...
                          <i class="fa fa-location-arrow" ></i>
                              ...
                              <label htmlFor="city_field" className='ml-2'>City :</label>
                          ...
                          <div className="form-group">
                            <i class="fa fa-phone"></i>
                              <label htmlFor="phone_field" className="ml-2">Phone Number :</label>
