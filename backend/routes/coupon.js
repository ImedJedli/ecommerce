...
const { createCoupon, getAllCoupon,getCouponByCode, getSingleCoupon, updateCoupon, deleteCoupon} = require('../controllers/couponController');

router.route('/admin/coupon/new' ).post(isAuthentificationUser,authorizeRoles('admin'),createCoupon);
